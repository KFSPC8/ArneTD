...
--Sell Building function coded by Arne
function BuildingHelper:SellBuilding(keys)
    local building = keys.unit
    local hero = building:GetOwner()
    local refund_factor = 0.75

    DebugPrint("[ARNE] SellBuilding "..building:GetUnitName().." "..building:GetEntityIndex())
    ...
    ModifyLumber2( hero:GetPlayerOwner(), lumber_cost)
