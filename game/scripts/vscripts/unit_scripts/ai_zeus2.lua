function Spawn( entityKeyValues )
	...
	local arc_lightning = thisEntity:FindAbilityByName("zuus_arc_lightning_custom")
	arc_lightning:SetLevel(4)
...
function AI_Zeus_Think(thisEnt)
  ...
  local arc_lightning = thisEnt:FindAbilityByName("zuus_arc_lightning_custom")
